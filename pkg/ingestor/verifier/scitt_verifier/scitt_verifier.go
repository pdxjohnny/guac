...
import (
	...
	"github.com/scitt/scitt/pkg/signature"
	sig_dsse "github.com/scitt/scitt/pkg/signature/dsse"
	"github.com/secure-systems-lab/go-securesystemslib/dsse"
)

type scittVerifier struct {
}

// NewSCITTVerifier initializes the scitt verifier
func NewSCITTAndKeyVerifier() *scittVerifier {
	return &scittVerifier{}
}
...
func (d *scittVerifier) Verify(ctx context.Context, payloadBytes []byte) ([]verifier.Identity, error) {
	...
	for _, signature := range envelope.Signatures {
		...
		// see:
		// https://github.com/scitt/scitt/blob/main/pkg/signature/dsse/dsse.go#L107
		// and
...
func (d *scittVerifier) Type() verifier.VerifierType {
	return "scitt"
}
